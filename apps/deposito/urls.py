...
urlpatterns = [
    ...
    path('nuevo/', login_required(views.deposito_usuario), name='deposito_usuario'),
    path('operaciones/deposito-solicitud', login_required(views.deposito_solicitud), name='deposito_solicitud'),
