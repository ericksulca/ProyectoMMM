...
class RecoverDone(SaltMixin, generic.TemplateView):
    template_name = 'reset/reset_sent.html'
...
class Recover(SaltMixin, generic.FormView):
    ...
    template_name = 'reset/recovery_form.html'
    success_url_name = 'password_reset_sent'
    email_template_name = 'reset/recovery_email.txt'
    email_subject_template_name = 'reset/recovery_email_subject.txt'
...
class ResetDone(generic.TemplateView):
    template_name = 'reset/recovery_done.html'
